...
function gb_OnKeyDown_Event(e) {
  ...
  switch (e.which) {
    ...
    // left
    case 188: gbPin14&=0xFD; MEMW(_IF_,gbRegIF|16); e.preventDefault(); return;
    // right
    case 190: gbPin14&=0xFE; MEMW(_IF_,gbRegIF|16); e.preventDefault(); return;    
    // start
...
function gb_OnKeyUp_Event(e) {
  switch (e.which) {
    ...
    // left
    case 188: gbPin14|=2; MEMW(_IF_,gbRegIF|16); e.preventDefault(); return;
    // right
    case 190: gbPin14|=1; MEMW(_IF_,gbRegIF|16); e.preventDefault(); return;
    // start
